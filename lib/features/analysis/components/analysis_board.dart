...
class AnalysisBoard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Adicionamos o Center para o tabuleiro não ficar colado no topo caso sobre espaço vertical
    return Center(
      child: LayoutBuilder(
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Observer(builder: (_) {
                      final _ = store.currentFen; // Força re-renderização
                      ...
                      return Container(
                        ...
                        child: Stack(
                          children: [
                            ...
                            // MELHORIA NO MAPA DE CALOR: Ataques (Esq) / Defesas (Dir) com fundo legível
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: Colors.black54, // Fundo escuro translúcido
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text('${stats.attacks}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.white)),
                                        ],
                                      ),
                                    ),
                                    // DIREITA: Defesas
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          Text('${stats.defenses}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.white)),
                                          const SizedBox(width: 2),
                                          const Icon(Icons.shield, color: Colors.lightBlueAccent, size: 12),
                                        ],
                                      ),
                                    ),
                                  ],
